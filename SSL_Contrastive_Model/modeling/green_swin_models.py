...
class PatchMerging(nn.Module):
    ...
    def forward(self, x, coords_prev, mask_prev):
        ...
        # print(f'mask_prev shape:{mask_prev.shape}')
        # print(mask_prev)
        ...
        # print(f'mask_new shape:{mask_new.shape}')
        # print(f'unique mask_new:{torch.unique(mask_new).shape}')
        # print(mask_new)
        assert torch.unique(mask_new).shape[0] == 2, f'unique mask_new:{torch.unique(mask_new).shape}'
...
class SwinTransformer(BaseGreenModel):
    ...
    def forward_features(self, x, mask):
        ...
        # print(f'x_vis shape:{x_vis.shape},coords shape:{coords.shape},vis_mask shape:{vis_mask.shape}')
        # transformer forward
