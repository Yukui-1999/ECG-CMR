...
from data.dataset import ECGzheyi_two_Base, ECGzheer_two_Base, ECGquzhou_two_Base, ECGzheyi_two_wGenCMR, ECGzheer_two_wGenCMR, ECGquzhou_two_wGenCMR
...
def main(args):
    ...
    if args.private_hospital == 'zheer':
        ...
        if args.use_gen_cmr:
            ...
            test_set = ECGzheyi_two_Base(isTrain=False)
    else:
...
if __name__ == '__main__':
    ...
    if args.private_hospital == 'zheyi':
        args.output_dir = '/mnt/sda1/dingzhengyao/Work/ECG_CMR_CardioNets_v1/ECG_CMR_zheyi_Bin_infer/'
