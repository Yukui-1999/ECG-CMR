...
def main(args):
    ...
    # dataset
    train = json.load(open('/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/data/train_ecgcmr_w_phelist_v1.json', 'r'))
    valid = json.load(open('/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/data/val_ecgcmr_w_phelist_v1.json', 'r'))
    # dataset
