...
class ECGEncoder(timm.models.vision_transformer.VisionTransformer):
    ...
    """
    def __init__(self, global_pool=False,condition_dim=24,args=None, **kwargs):
...
if __name__ == '__main__':
    model = vit_base_patchX(img_size=(12,5000),patch_size=(1,100),in_chans=1)
    out = model(torch.randn(1, 1, 12, 5000),torch.randn(1, 24))
    print(out[1].shape)