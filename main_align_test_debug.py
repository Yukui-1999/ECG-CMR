...
def get_args_parser():
    ...
    parser.add_argument('--ecg_pretrained_weights', default="/mnt/sda1/dingzhengyao/Work/ECG_CMR_CardioNets_v1/ECG_CMR_align/ECG_STME_CMR_base_bs256_lr0.001_optadamw_clip0.05_seed42/best-loss.pth", type=str, help='pretrained weights path')
    ...
    parser.add_argument('--idx', default=0, type=int, help='index for debug')
    return parser
...
def main(args):
    ...
    if args.exp_type == 'align':
        save_dir = f'/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/align_attn/debug/align_idx{str(args.idx)}'
    elif args.exp_type == 'pretrain':
        save_dir = f'/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/align_attn/debug/pretrain_idx{str(args.idx)}1'
        ...
        save_dir = f'/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/align_attn/debug/scratch_idx{str(args.idx)}'
    elif args.exp_type == 'align_not_freeze':
        save_dir = f'/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CardioNets_v1/align_attn/align_not_freeze'
    ...
    ECG_model.eval()
    if args.exp_type == 'align' or args.exp_type == 'align_not_freeze' or args.exp_type == 'phen_sup':
