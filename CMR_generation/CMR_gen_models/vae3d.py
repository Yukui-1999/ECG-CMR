...
from CMR_generation.ldm.util import compute_ssim, compute_psnr, default, instantiate_from_config
from CMR_generation.ldm.modules.diffusionmodules.model import make_conv, nonlinearity, ResnetBlock, Normalize, checkpoint_new
...
class VAE3d(nn.Module):
    ...
    def forward(self, batch):
        frame_length = torch.tensor(batch.shape[2], dtype=torch.long) # bs, c, f, h, w
